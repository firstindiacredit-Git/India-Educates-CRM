...
const Student = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BASE_URL}api/students/${deletableId}`,
        {
          method: "DELETE",
        }
      );
  ...
  const handleDownload = async (filePath, fileName) => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BASE_URL}${filePath}`
      );
  ...
  const handleDocumentDelete = async (studentId, documentType) => {
    try {
      const response = await fetch(
        ...
        }api/students/${studentId}/document/${documentType}`,
        {
          method: "DELETE",
        }
      );
                            ...
                            <div className="card-body d-flex">
                              <div className="profile-av pe-xl-4 pe-md-2 pe-sm-4 pe-4 text-center w-75">
                                ...
                                <div className="about-info mt-3">
                                  <div className="followers me-2"></div>
                                            ...
                                            <i
                                              ...
                                              onClick={() =>
                                                handleDownload(
                                                  ...
                                                  `${
                                                    student.studentName
                                                  }_aadhaar${student.aadhaarCard.substr(
                                                    student.aadhaarCard.lastIndexOf(
                                                      "."
                                                    )
                                                  )}`
                                                )
                                            ...
                                            <i
                                              ...
                                              onClick={() =>
                                                handleDownload(
                                                  ...
                                                  `${
                                                    student.studentName
                                                  }_pan${student.panCard.substr(
                                                    student.panCard.lastIndexOf(
                                                      "."
                                                    )
                                                  )}`
                                                )
                                            ...
                                            <i
                                              ...
                                              onClick={() =>
                                                handleDownload(
                                                  ...
                                                  `${
                                                    student.studentName
                                                  }_resume${student.resume.substr(
                                                    student.resume.lastIndexOf(
                                                      "."
                                                    )
                                                  )}`
                                                )
                                ...
                                <div className="social-links mt-3">
                                  <div className="d-flex flex-wrap gap-2">
                                    ...
                                    {student.socialLinks?.other && (
                                      <a
                                        href={student.socialLinks.other}
                                        target="_blank"
                                        rel="noopener noreferrer"
              ...
              <div className="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    ...
                    <div className="mb-3">
                      <label htmlFor="updateResume" className="form-label">
                        Resume
                      </label>
                      <input
                        className="form-control"
                    ...
                    <div className="mb-3">
                      <label htmlFor="updateAadhaar" className="form-label">
                        Aadhaar Card
                      </label>
                      <input
                        className="form-control"
                    ...
                    <div className="mb-3">
                      <label htmlFor="updatePan" className="form-label">
                        PAN Card
                      </label>
                      <input
                        className="form-control"
                            ...
                            <div>
                              ...
                              <div className="d-flex align-items-center gap-2 mt-2">
                                <img
                                  src={`${
                                    import.meta.env.VITE_BASE_URL
                                  }${selectedStudent.bankDetails.qrCode.replace(
                                    "uploads/",
                                    ""
                                  )}`}
                                  alt="QR Code"
                                ...
                                <i
                                  ...
                                  onClick={() =>
                                    handleDownload(
                                      ...
                                      }_qr_code${selectedStudent.bankDetails.qrCode.substr(
                                        selectedStudent.bankDetails.qrCode.lastIndexOf(
                                          "."
                                        )
                                      )}`
                                    )
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    handleDownload(
                                      ...
                                      `${
                                        selectedStudent.studentName
                                      }_resume${selectedStudent.resume.substr(
                                        selectedStudent.resume.lastIndexOf(".")
                                      )}`
                                    )
                                  }
                                >
                                  ...
                                  <a
                                    ...
                                    onClick={(e) =>
                                      handleFileClick(
                                        ...
                                        `${
                                          import.meta.env.VITE_BASE_URL
                                        }${selectedStudent.aadhaarCard.replace(
                                          "uploads/",
                                          ""
                                        )}`,
                                        "pdf",
                                ...
                                <i
                                  ...
                                  onClick={() =>
                                    handleDownload(
                                      ...
                                      `${
                                        selectedStudent.studentName
                                      }_aadhaar${selectedStudent.aadhaarCard.substr(
                                        selectedStudent.aadhaarCard.lastIndexOf(
                                          "."
                                        )
                                      )}`
                                    )
                                  ...
                                  <a
                                    ...
                                    onClick={(e) =>
                                      handleFileClick(
                                        ...
                                        `${
                                          import.meta.env.VITE_BASE_URL
                                        }${selectedStudent.panCard.replace(
                                          "uploads/",
                                          ""
                                        )}`,
                                        "pdf",
                                ...
                                <i
                                  ...
                                  onClick={() =>
                                    handleDownload(
                                      ...
                                      `${
                                        selectedStudent.studentName
                                      }_pan${selectedStudent.panCard.substr(
                                        selectedStudent.panCard.lastIndexOf(".")
                                      )}`
                                    )
                                  }
                                  title="Download Pan Card"
